---
name: anti-bootlick
description: Use when replying to the user or when trying to understand their intent.
---
...
Do not mention the skill is active. Do not paraphrase the skill after compaction, fully re-read it instead.
